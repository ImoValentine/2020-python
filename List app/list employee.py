...
class Window(QDialog):
    ...
    def Employee(self):
        self.employess = ["Cape Town", "Paris", "Rio", "Hong Kong", "Amsteram"]
    ...
    def setupUi(self, Dialog):
        ...
        self.listWidget = QtWidgets.QListWidget(Dialog)###list widget
        ...
        self.namelabel=QtWidgets.QLabel(Dialog)#name label
        self.namelabel.setGeometry(QtCore.QRect(250, 25, 150, 850))## Geometry Of name label
        self.lisconlabel=QtWidgets.QLabel(Dialog)#List counter label
        self.lisconlabel.setGeometry(QtCore.QRect(250, 25, 150, 750))
        self.lisconlabel.setWordWrap(True)
        #disp_count=self.listWidget.count()############
        ...
        self.Employee()
        self.value1=self.listWidget.count()

       # self.lisconlabel.connect(self.cont)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.namelabel.setText(_translate("Dialog", "Imraan Jacobs 11641584"))#student details label 
        self.lisconlabel.setText(_translate("Dialog", value))#student details label
    ...
    def add(self):
        ...
        text, ok = QInputDialog.getText(self, "City Dialog", "Enter city Name")
    ...
    def edit(self):
        ...
        if item is not None:
            string, ok = QInputDialog.getText(self, "City Dialog", "Edit city Name",
    ...
    def remove(self):
        ...
        reply = QMessageBox.question(self, "Remove City", "Do You Want To Remove city " + str(item.text()),
