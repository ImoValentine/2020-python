...
class InsertDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("Add city")
        self.setFixedWidth(300)
        self.setFixedHeight(300)

        self.setWindowTitle("Insert city")
        self.setFixedWidth(300)
        self.setFixedHeight(300)
        ...
        self.nameinput.setPlaceholderText("City Name")
    ...
    def addstudent(self):
        ...
        try:
            ...
            self.c.execute("INSERT INTO students (name,branch,sem,Mobile,address) VALUES (?,?,?,?,?)",(name,branch))
            self.conn.commit()
            self.c.close()
            self.conn.close()
...
class SearchDialog(QDialog):
    ...
    def searchstudent(self):
        ...
        try:
            ...
            QMessageBox.warning(QMessageBox(), 'Error', 'Could not Find city from the database.')
...
class DeleteDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("Delete city")
        self.setFixedWidth(300)
        self.setFixedHeight(100)
...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        title = QLabel("City Record Maintainer In PyQt5")
        font = title.font()
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("City Record Maintainer In PyQT5")
        ...
        self.tableWidget.setHorizontalHeaderLabels(("Roll No.", "City Name"))
        ...
        adduser_action = QAction(QIcon("icon/add1.jpg"),"Insert city", self)
        adduser_action.triggered.connect(self.insert)
        file_menu.addAction(adduser_action)

        searchuser_action = QAction(QIcon("icon/s1.png"), "Search city", self)
